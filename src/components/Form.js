          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={this.handleChange}
                type="text"
                className={`form-control ${touch.tagline && error.tagline ? "is-invalid" : ""}`}
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={this.handleChange}
                className={`form-control ${
                  touch.attenuation_level && error.attenuation_level ? "is-invalid" : ""
                }`}
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={this.handleChange}
                className={`form-control ${
                  touch.contributed_by && error.contributed_by ? "is-invalid" : ""
                }`}
